...
sys.path.append( "D:\Studies\DS\Dev\ud120-projects-master/tools/" )
...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        for x in replace_list:
            emails = emails.replace(x, '')
        print("new")

        ### append the text to word_data
        word_data.append(emails)
...
print(vectorizer.get_feature_names())[33615]
